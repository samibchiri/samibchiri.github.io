...
// Function to handle the MoveCardClick logic
async function MoveCardClick(PokemonApi) {
    let PokemonCard = Array.from(ListPokemons.querySelectorAll(".PokemonCard"));
    // Return a Promise that will be resolved when the button is clicked
    ...
    return new Promise((resolve) => {
        ...
        let FirstNumChosenPokemon=NumChosenPokemon
       
        document.getElementById("FinishPokemon").addEventListener("click", function() {
            
            console.log(ListMoves.style.display)
